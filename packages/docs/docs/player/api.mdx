...
### `preservesPitch?`<AvailableFrom v="4.0.452" />

Boolean to control whether audio pitch should stay constant when `playbackRate` changes.

By default, browser behavior is used.
